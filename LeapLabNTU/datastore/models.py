...
class Baby(Person):
	...
	language_spoken_in_home_between_parents = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_spoken_in_home_between_siblings = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_spoken_in_home_between_maternal_grandparents = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_spoken_in_home_between_paternal_grandparents = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_spoken_in_home_between_parents_and_other_relatives = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_spoken_in_home_between_parents_and_other_caregivers = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_used_in_home_for_reading = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_used_in_home_for_listening_to_radio_or_music = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_used_in_home_for_watching_tv_or_video = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_used_in_home_for_using_internet_or_smartphones = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_used_in_home_for_reading_stories_to_child = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	...
	language_child_speaks_to_mother = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_speaks_to_father = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_speaks_to_siblings = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_speaks_to_maternal_grandparents = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_speaks_to_paternal_grandparents = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_speaks_to_other_relatives = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_speaks_to_friends = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_for_reading = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_for_listening_to_radio_or_music = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_for_watching_tv_or_video = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_for_watching_tv_or_video = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_internet_or_smartphones_in = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_overall_to_speak_at_home = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE)
	language_child_uses_overall_to_speak_within_your_community = models.IntegerField(choices = CHOICES_LANGUAGE_PREVALENCE) 
